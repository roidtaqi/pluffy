...
class AppColors {
  ...
  static const Color primary = Color(
    0xFF9B1B1B,
  ); // Deep Crimson (Cherry/Strawberry)
  static const Color background = Color(
    0xFFFBF7F0,
  ); // Warm Cream (Main background)
  static const Color cardBg = Color(
    0xFFFAF0DC,
  ); // Almond Custard (Cards and Containers)
  static const Color border = Color(
    0xFFE8C9A0,
  ); // Golden Biscuit (Borders/Dividers)
  static const Color accent = Color(
    0xFFF4A58A,
  ); // Peach Coral (Promos and Highlights)
  static const Color textMain = Color(
    0xFF2C1E1B,
  ); // Dark Cacao (Main Titles & Heavy Text)
  static const Color textSecondary = Color(
    0xFF7D6F6C,
  ); // Chestnut Grey (Secondary/Subtexts)
  ...
  static const LinearGradient warmGradient = LinearGradient(
    ...
    colors: [Color(0xFF9B1B1B), Color(0xFFB82F2F)],
  );

  static const LinearGradient promoGradient = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: [Color(0xFFF4A58A), Color(0xFFFAF0DC)],
  );
}
