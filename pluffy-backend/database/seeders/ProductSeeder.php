...
class ProductSeeder extends Seeder
{
    ...
    {
        Product::firstOrCreate(['name' => 'Pluffy Cloud Soufflé'], [
        ...
        Product::firstOrCreate(['name' => 'Strawberry Cream Soufflé'], [
        ...
        Product::firstOrCreate(['name' => 'Butter Cream Croissant'], [
        ...
        Product::firstOrCreate(['name' => 'Pluffy Cloud Latte'], [
        ...
        Product::firstOrCreate(['name' => 'Iced Burgundy Latte'], [
        ...
        Product::firstOrCreate(['name' => 'Peach Cream Tea'], [
        ...
        Product::firstOrCreate(['name' => 'Seasonal Berry Fizz'], [
